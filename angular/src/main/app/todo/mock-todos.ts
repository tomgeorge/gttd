...
export var TODOS: Todo[] = [
   ...
   'description': `
        ...
        ,
        'inProgress': false, 'time': 123456789, estimate: 0, completed: false, startTime : 0, endTime : 0},
   { 'id': 2, 'name': 'figure out why vagrant minions become unreachable',
   'description': `
        first time you set up deploy user/ssh it works.  Subsequent runs it fails
        `,
   ...
   { 'id': 5, 'name': 'Project: to-do app',
     'description': `
        ...
        `,
        'inProgress': false, 'time': 0, estimate: 0, completed: false, startTime : 0, endTime : 0},
   { 'id': 6, 'name': 'Folders used by docker/kubernetes',
     'description': `
        /var/lib/docker, /var/lib/kubernetes, /var/lib/kubelet, /etc/kubernetes, /var/lib/etcd, /var/lib/registry
        `,
        'inProgress': false, 'time': 0, estimate: 0, completed: false, startTime : 0, endTime : 0}
];
