...
export var TODOS: Todo[] = [
    ...
    .setDescription( `set up chat server.  figure out how to do mixed-architecture deployments so I can run a jenkins server on the
    ...
    .setDescription(` be done to be able to edit on host, [see change in browser on vagrant box | see change in browser in docker
